          ...
          <AnimatePresence>
            {phase === "prompt" && (
              ...
              >
                ...
                <motion.div
                  className="pointer-events-none absolute left-[42%] top-[68%] h-[18vh] min-h-[112px] w-[18vh] min-w-[112px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-amber-200/20"
                  initial={{ opacity: 0 }}
