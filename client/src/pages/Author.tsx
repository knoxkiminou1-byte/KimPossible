              ...
              >
                ...
                <div className="space-y-8 text-gray-300 text-lg leading-relaxed">
                  ...
                  <div className="space-y-4">
	                    ...
	                    <p>
	                      Kiminou Knox is the author of 10 published works across poetry, fiction, faith-centered writing, children's storytelling, and collaborative projects. His catalog includes <em className="text-amber-300/90">Kiminou's World of Imagination: The Basics</em>, <em className="text-amber-300/90">Poems From A Black Boy</em>, <em className="text-amber-300/90">Black Boy Poems</em>, <em className="text-amber-300/90">Hopeless Romantic</em>, <em className="text-amber-300/90">The Spirit of Solomon</em>, <em className="text-amber-300/90">Our Father</em>, <em className="text-amber-300/90">Boys Raised In Silence</em>, <em className="text-amber-300/90">The Adventures of Kiminou the Great and Chua the Wise</em>, <em className="text-amber-300/90">WHY DID YOU GHOST ME</em>, and <em className="text-amber-300/90">7.16.74: An Ode to Rashida</em>.
	                    </p>
	                    <p>
