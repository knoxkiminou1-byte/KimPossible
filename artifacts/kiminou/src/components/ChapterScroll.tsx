...
const CHAPTERS = [
  ...
  },
  {
    ...
    subline: "varsity Eligible · 6'7\" · 235 lbs",
    body: "Forward. Center. Cristo Rey De La Salle. varsity registered. The same discipline that makes a book makes a player — complete focus, no excuses, maximum output. Basketball is another language for the same story.",
