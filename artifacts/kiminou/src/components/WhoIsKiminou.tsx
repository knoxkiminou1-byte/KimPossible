...
const identity = [
  {
    ...
    description: "Eight books. Faith, identity, love, and the Black experience written straight from the source, no filter.",
    link: "/books",
    cta: "View Books",
  },
  {
  ...
  },
  {
    ...
    description: "He speaks from what he has lived. Craft, discipline, faith, and what it actually takes to grow up with something to say.",
    link: "/speaking",
    cta: "Book Speaking",
  },
  {
    ...
    label: "Director",
    title: "AAFC Leader",
    description: "Director of AAFC. He builds programs that give young creatives and athletes an actual path forward.",
    link: "/contact",
    cta: "Connect",
  },
];
