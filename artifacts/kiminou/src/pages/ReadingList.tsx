  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Curated books on Black identity, faith, athletics, and craft from Kiminou Knox — eight-time published author and NCAA athlete." />
